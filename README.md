...
<br/>
###### 2nd Letter
The 2nd row shows the next series of numbered grids from left-to right translate to the numbers ranging from 0-9 from the word list consisting of 4 digits.<br/>
**This is the 2nd digit corresponding to the 2nd letter of the seed word.**
<br/>
###### 3rd Letter
The 3rd row shows the next series of numbered grids from left-to right translate to the numbers ranging from 0-9 from the word list consisting of 4 digits.<br/>
**This is the 3rd digit corresponding to the 3rd letter of the seed word.**
<br/>
###### 4th Letter
The 4th row shows the next series of numbered grids from left-to right translate to the numbers ranging from 0-9 from the word list consisting of 4 digits.<br/>
...
## Description - 3x11
There is a grid of 3 rows of 11 columns; hence the "3x11" name.  There are 6 of these grids on the 6-Word-Plate™, CipherTag™ and CipherLegacy™; 12 grids on the 12-Word-Plate™.
...
<br/>
###### An example of an encoded word on the CipherTag™
<br/>
<br/>
<br/>
